export class TimelineAnimation {
    ...
    initialize() {
        ...
        this.observer = new IntersectionObserver((entries) => {
            entries.forEach((entry) => {
                ...
                if (!document.body.contains(el)) {
                    (_a = this.observer) === null || _a === void 0 ? void 0 : _a.unobserve(el);
                }
            });
        }, {
            root: null,
        ...
        this.elements.forEach((el) => { var _a; return (_a = this.observer) === null || _a === void 0 ? void 0 : _a.observe(el); });
    }
    ...
    destroy() {
        var _a;
        this.elements.forEach((el) => { var _a; return (_a = this.observer) === null || _a === void 0 ? void 0 : _a.unobserve(el); });
