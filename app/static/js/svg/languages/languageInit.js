...
if (svgElement) {
    mainContainer = new LanguageMainBorder("language-main-svg", {
...
export function createSmall() {
    const getParent = document.querySelector(".languages-small");
    const getChildren = getParent === null || getParent === void 0 ? void 0 : getParent.getElementsByTagName("svg");
}
