import { MainBorder } from "./maincontainer/LanguageMainBorder.js";
import { InnerBorder } from "./maincontainer/LanguageMainBorder.js";
import { LanguageMainStyling } from "./maincontainer/MainStyling.js";
import { LanguageAddedFeatures } from "./maincontainer/LanguageMainAddedFeatures.js";
import { CreateFiguresFromPaths } from "./maincontainer/LanguageInnerBorder.js";
...
export const mainContainer = new MainBorder("language-main-svg", {
...
export const figure = new CreateFiguresFromPaths(mainContainer);
// export function exportClass(): void
// {
//     mainContainer.init()
//     figure.init()
//     LanguageMainStyling.createGradient()
//     LanguageAddedFeatures.createSideBars()
//     LanguageAddedFeatures.createTextInSVG()
// }
export const proto = new MainBorder("proto-svg", {
    viewBox: "-3 -3 1006 682",
    preserveAspectRatio: "xMidYMid meet"
}, true, "language", outerPath);
...
export const figureProto = new CreateFiguresFromPaths(proto);
