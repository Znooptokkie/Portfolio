...
// CV - Motivation Title
const motivationTitleShape = new VectorShapes(
    ".cv-mot-svg svg",
    "CV - Motivation",
    "title"
);
...
const motivationSubtitleShape = new VectorShapes(
    ".cv-mot-svg svg",
    "Why Programming?",
    "subtitle"
);
...
// CV - Interest Title
const interestTitleShape = new VectorShapes(
    ".cv-inter-svg svg",
    "CV - Interests",
    "title"
);
...
const interestSubtitleShape = new VectorShapes(
    ".cv-inter-svg svg",
    "What do I like?",
    "subtitle"
);
...
// CV - Expertise Title
const expertiseTitleShape = new VectorShapes(
    ".cv-exper-svg svg",
    "CV - Expertise",
    "title"
);
...
const expertiseSubtitleShape = new VectorShapes(
    ".cv-exper-svg svg",
...
// CV - Language Title
const languageTitleShape = new VectorShapes(
    ".cv-lang-svg svg",
    "CV - Languages",
    "title"
);
...
const languageSubtitleShape = new VectorShapes(
    ".cv-lang-svg svg",
...
const dropdownMenu = document.querySelector<HTMLElement>(".nav-header-dropdown");
const toggleButton = document.querySelector<HTMLButtonElement>(".nav-toggle-button");
